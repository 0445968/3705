...
const MOCK_WORKSPACES = [
  {
    id: '1',
    name: 'Marketing',
    description: 'Campaign assets, social media, and advertising materials',
    memberCount: 5,
    requestCount: 8,
    color: '#2563eb',
  ...
  },
  {
    id: '2',
    name: 'Product Design',
    description: 'UI/UX design, product mockups, and prototypes',
    memberCount: 3,
    requestCount: 4,
    color: '#10b981',
    updatedAt: '1 day ago',
  },
  {
    id: '3',
    name: 'Executive',
    description: 'Annual reports, presentations, and board materials',
    memberCount: 2,
    requestCount: 2,
    color: '#f59e0b',
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <p className="mb-6 max-w-xs text-sm text-muted-foreground leading-relaxed">
        Organize your creative work into dedicated workspaces for different
        teams or projects.
      </p>
...
function WorkspaceCard({
  ...
  workspace: (typeof MOCK_WORKSPACES)[0];
}) {
  return (
      ...
      <div className="grid grid-cols-3 gap-3">
        {[
          ...
          },
          {
            ...
            value: MOCK_WORKSPACES.reduce((a, w) => a + w.requestCount, 0),
            color: 'text-blue-400',
          },
